...
var SinaLiveService = /** @class */ (function () {
    function SinaLiveService(http) {
        this.http = http;
        this.base = '//ing.weibo.com/api/live/flashplayinfo';
        this.pKey = '22f18e62a05fb5e4fe4000e6e97ced10';
        this.key = '';
        this.uri = '';
        this.query = '';
    }
    SinaLiveService.prototype.buildQueryString = function (userId, uid, expiresHours) {
        if (expiresHours === void 0) { expiresHours = 2; }
        this.query = '';
        var a = {
            id: userId,
            uid: uid,
    ...
    SinaLiveService.prototype.getSign = function (userQueryString) {
        this.key = '';
        this.key = this.a(userQueryString + this.pKey, null, null);
        return this.key;
    };
    SinaLiveService.prototype.buildStreamUri = function () {
        return 'http:' + this.base + '?' + this.query + '&sign=' + this.key;
    };
    SinaLiveService.prototype.getStream = function (uriStr) {
        return this.http.get(uriStr);
    };
    SinaLiveService.prototype.a = function (a, b, c) {
        function v(a, b, c) {
            if (!b) {
                return c ? r(a) : s(a);
            }
    ...
    SinaLiveService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
    ], SinaLiveService);
    return SinaLiveService;
}());
exports.SinaLiveService = SinaLiveService;
